package org.lanqiao.util.result;
...
public class ResultFactory {
    ...
    //返回错误，可以传msg
    public static Result setResultError(Integer code, String msg, Object data){
        return setResult(ResultCode.HTTP_RES_CODE_500,ResultCode.HTTP_RES_CODE_500_VALUE,data);
    }
    //返回成功，可以传data值
    ...
    public static Result setResultSuccess(Integer code,String msg){
        return setResult(code,msg,null);
    }
    ...
    public static Result setResultSuccess(int code, String msg, Object data) {return new Result(code, msg,data);
    }
}
